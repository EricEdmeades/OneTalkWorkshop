...
export function renderDashboard({ report, feedback, fetchedAt, truncated, maxSessions }) {
  ...
  <h1>Reports</h1>
  <p class="generated">${escapeHtml(formatTimestamp(fetchedAt))} Eastern · ${escapeHtml(describeFreshness(fetchedAt, 'Stripe'))} · <a href="/results?refresh=1">refresh</a></p>
  ...
  <p class="note">
    Registration figures come from Stripe and are cached for a few minutes; feedback is
